    ...
    return (
        <section className = "relative flex flex-col items-center justify-center h-screen bg-gradient-to-r from-gray-900 via-black to-fuchsia-950 text-white overflow-hidden">
            ...
            <div className = "mt-6 flex gap-4">
                <button className = "relative px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-500 rounded-lg text-white text-lg font-semibold shadow-lg transform transition-all duration-300 hover:scale-105">
                    Get Started
